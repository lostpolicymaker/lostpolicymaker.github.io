...
<div class="lp-hero">
  ...
  <div class="lp-hero-tags">lostpolicymaker.org &middot; #lostpolicymaker</div>
...
In recent years public policymakers have increasingly frequented hacker and infosec conferences — so much so that DEF CON now runs a dedicated [Policy program](https://defcon.org/policy/). This guide can serve as a reference and roadmap to help those in the policy field more quickly gain their footing at the events and understand hacker ethos and culture.
<br>
...
Follow [Policy @ DEF CON](https://defcon.org/policy/) to track the action — on Bluesky at [@defconpolicy.bsky.social](https://bsky.app/profile/defconpolicy.bsky.social) or Mastodon at [@defconpolicy@defcon.social](https://defcon.social/@defconpolicy). Engage with your fellow policymakers using #lostpolicymaker and #defconpolicy on your favorite social media outlets.
